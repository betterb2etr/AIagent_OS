...
exports.createJsonParseErrorEvent = createJsonParseErrorEvent;
...
exports.createAssistantMessageEvent = createAssistantMessageEvent;
...
const completeValidationError_1 = require("../orchestrate/internal/completeValidationError");
...
function createValidateEvent(props) {
    (0, completeValidationError_1.complementValidationError)(props.result);
    const created_at = new Date().toISOString();
    return {
        type: "validate",
        id: props.id,
